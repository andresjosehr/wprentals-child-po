        ...
        <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="col-md-4 contact_page_company_picture">
                <div class="company_headline ">   
                    ...
                    <?php      
                    if ($telephone_no) {
                        print '<div class="agent_detail contact_detail"><i class="fas fa-phone"></i><a href="tel:' . $telephone_no . '">'; print  $telephone_no . '</a></div>';
                    }

                     if ($mobile_no) {
                        print '<div class="agent_detail contact_detail"><i class="fas fa-mobile-alt"></i><a href="tel:' . $mobile_no . '">'; print  $mobile_no . '</a></div>';
                    }

                    if ($company_email) {
                        print '<div class="agent_detail contact_detail"><i class="far fa-envelope"></i>'; print '<a href="mailto:'.$company_email.'">' . $company_email . '</a></div>';
                    }
                    
                    if ($fax_ac) {
                        print '<div class="agent_detail contact_detail"><i class="fab fa-instagram"></i>';print   $fax_ac . '</div>';
                    }
                    
                    if ($skype_ac) {
                        print '<div class="agent_detail contact_detail"><i class="fab fa-skype"></i>';print   $skype_ac . '</div>';
                    }

                    if ($co_address) {
                        print '<div class="agent_detail contact_detail"><i class="fas fa-home"></i>';print   $co_address . '</div>';
                    }
                    ?>
                    ...
                    <div class="header_social">
                        <?php
                        if($facebook_link!=''){
                            print ' <a href="'. $facebook_link.'" target="_blank" class="share_facebook"><i class="fab fa-facebook-f"></i></a>';
                        }

                        if($twitter_link!=''){
                           print ' <a href="'.$twitter_link.'" target="_blank" class="share_tweet"><i class="fab fa-twitter"></i></a>';
                        }
                        
                        if($google_link!=''){
                            print ' <a href="'. $google_link.'" target="_blank" class="share_google"><i class="fab fa-google-plus-g"></i></a>';
                        }

                        if($linkedin_link!=''){
                            print ' <a href="'.$linkedin_link.'" target="_blank" class="share_linkedin"><i class="fab fa-linkedin-in"></i></a>';
                        }

                        if($pinterest_link!=''){
                             print ' <a href="'. $pinterest_link.'" target="_blank" class="share_pinterest" ><i class="fab fa-pinterest-p"></i></a>';
                        }
                        ?>
                    </div>     
                </div>  
