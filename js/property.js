...
function check_in_out_enable2(in_date, out_date) {
    ...
    //Estas funciones muestran el precio cuando se pone encima el ratón y se va cuando se quita
...
function show_booking_costs() {
        ...
        //console.log("show_booking_costs en property.js");
     
        jQuery.ajax({
            type: 'POST',
            url: ajaxurl,
            data: {
                'action'            :   'wpestate_ajax_show_booking_costs_show',
                'fromdate'          :   fromdate,
                'todate'            :   todate,
...
function wpestate_booking_form_currency_convert_back(display_price){
    ...
    $('#submit_booking_front,#submit_booking_front_instant').click(function (event) {
        ...
        console.log("submit_booking_front");
        event.preventDefault();
        ...
        var number_members, show_price, policy_accept;
        ...
        number_members  =   parseInt  (jQuery('#submit_booking_front').attr('data-numbermembers'),10);
        show_price      =   jQuery('#submit_booking_front').attr('data-showprice');
        policy_accept   =   document.getElementById("booking_policy_check").checked;
        ...
        console.log(property_vars.logged_in);

        console.log(policy_accept);

        if(!policy_accept){

            $('#booking_form_request_mess').show().empty().addClass('book_not_available').append(property_vars.policy_booking_check);
