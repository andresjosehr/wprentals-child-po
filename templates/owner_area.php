...
<div class="col-md-2 agentpic-wrapper<?php print esc_attr($verified_class);?>">
    <div class="owner_listing_image " style="background-image: url('<?php print $preview_img;?>');">
...
<div class="col-md-10 agentpic-wrapper">
    ...
    <a class="owner_read_more " href="<?php print $link?>"><?php esc_html_e('See Owner Profile','wprentals');?></a>
     <div  id="contact_me_long" class=" owner_read_more " data-postid="<?php the_ID();?>" ><?php esc_html_e('Contact Owner','wprentals');?></div>
</div>