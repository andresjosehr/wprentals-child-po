    ...
    <div class="advanced_search_map_list_container">
        ...
        ?>
            ...
            <div class="col-md-3 slider_radius_wrap">
                <div class="label_radius"><?php esc_html_e('Radius:','wprentals');?> <span class="radius_value"><?php print $radius_value.' '.$radius_measure;?></span></div>
            </div>

            <div class="col-md-9 slider_radius_wrap">
                <div id="wpestate_slider_radius"></div>
                <input type="hidden" id="geolocation_radius" name="geolocation_radius" value="<?php print $radius_value;?>">
            </div>
        <?php
        }
        ?>
        ...
        if($search_type == 'oldtype' || $search_type=='newtype'){ ?>
            ...
            <div class="col-md-6 map_icon">
                ...
                if($show_adv_search_general=='no'){
                    ...
                    print '<input type="hidden" class="stype" id="stype" name="stype" value="'.$search_location_tax.'">';
                }
                ...
                if ($wpestate_autocomplete_use_list=='yes' && $show_adv_search_general=='no'){
                   print wprentals_location_custom_dropwdown($_REQUEST,esc_html__('Where do you want to go ?','wprentals'));
                    ...
                    print '<input type="text"    id="search_location'.$wpestate_internal_search.'"      class="form-control" name="search_location" placeholder="'.esc_html__('Where do you want to go ?','wprentals').'" value="'.$search_location.'"  >';              
                } 
        ...
        <div class="col-md-6">
            <div class="adv_search_slider">
                <p>
                    ...
                    <span id="amount"  style="border:0; color:#b881fc; font-weight:bold;"><?php print wpestate_show_price_label_slider($min_price_slider,$max_price_slider,$currency,$where_currency);?></span>
                </p>
        ...
        if($extended_search=='yes'){
            ...
            print '<div class="adv_extended_options_text" id="adv_extended_options_text_adv" data-pageid="'. $post->ID.'">'.esc_html__('More Options','wprentals').'</div>';
        ...
        <?php } else{
            ...
            foreach($adv_search_what as $key=>$search_field){
                ...
                print '<div class="halfx col-md-'.$search_col.' '.str_replace(" ","_", stripslashes($search_field) ).' ">';
                    print wpestate_show_search_field_new($_REQUEST,'half',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$show_city_select_list);
            ...
            if($extended_search=='yes'){
                ...
                print '<div class="adv_extended_options_text" id="adv_extended_options_text_adv" data-pageid="'.$post_id.'">'.esc_html__('More Options','wprentals').'</div>';
            } 
