    ...
    <div class="user_dashboard_links">
        ...
        <?php if( $add_link!=$home_url  && $add_link!=""  && wpestate_check_user_level()){ 
            ...
            <div class=" property_edit_menu">     
                ...
                <a href="<?php print $edit_link_members;?>"    class="edit_listing_link <?php print $activemembers;?>">    <?php esc_html_e('Members','wprentals');?></a>   
                ...
                <a href="<?php print $edit_link_location;?>"     class="edit_listing_link <?php print $activelocation;?>">     <?php esc_html_e('Location','wprentals');?></a>
                 <a href="<?php print $edit_link_extras;?>"     class="edit_listing_link <?php print $activedextras;?>">     <?php esc_html_e('Extras','wprentals');?></a>
        ...
        <?php if( $dash_favorite!=$home_url && $dash_favorite!=""){ ?>
            <a href="<?php print $dash_favorite;?>" class="<?php print $activefav; ?>"><i class="fas fa-heart"></i> <?php esc_html_e('Favorites','wprentals');?></a>
        <?php } ?>
        ...
        <?php if( $dash_inbox!=$home_url  && $dash_inbox!=""){ 
            ...
            <a href="<?php print $dash_inbox;?>" class="<?php print $activeinbox; ?>"><div class="unread_mess_wrap_menu"><?php print $no_unread;?></div><i class="fas fa-inbox"></i> <?php esc_html_e('My Inbox','wprentals');?></a>
        <?php } ?>
            
        <?php if( $dash_invoice!=$home_url && $dash_invoice!="" && wpestate_check_user_level()  ){ ?>
            <a href="<?php print $dash_invoice;?>" class="<?php print $activeinvoice; ?>"><i class="far fa-file"></i> <?php esc_html_e('Invoices','wprentals');?></a>
        <?php } ?>
