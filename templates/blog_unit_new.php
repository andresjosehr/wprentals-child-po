...
?>
<div <?php print $schema_data;?> class="col-md-<?php print $row_number_col;?> new_blog ">
    
    <meta itemprop="position" content="<?php print $blog_selection->current_post;?>" />
   
         
    <div class="blog_unit_back full_blog " data-link="<?php print $link;?>">
        <?php 
        $title      =   get_the_title();
        if( has_post_thumbnail($post->ID) ){
            ...
            print '<div class="listing-unit-img-wrapper"> <div class="cross"></div><img itemprop="image"  src="'.$preview_img.'" class=" b-lazy  img-responsive" alt="'.$title.'" ></div>';
        }
