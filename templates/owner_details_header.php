    ...
    <div class="owner-page-wrapper">
        ...
        <div class="owner-page-wrapper-inside row">
            ...
            <div class="col-md-2 user_picture_owner_page">
                <div class="owner-image-container" style="background-image: url('<?php print $preview_img; ?>');"></div>
            ...
            <div class="col-md-10">
                    ...
                    <div class="property_ratings_agent">
                       ...
                       <span class="owner_total_reviews">(<?php 
                            if ( isset($comments_data['coments_no']) ){
                                print $comments_data['coments_no'];
                            }
                            ?>)</span>
                    </div>
                <?php } ?>
                <div class="agent_menu">
                    ...
                    <div class="agent_general_details">
                        <span class="property_menu_item_title"><span class="contact_title"><i class="fas fa-map-marker-alt"></i></span>   
                            <?php 
                            $live_in = esc_html(get_post_meta($post->ID, 'city', true)); 
                            if($live_in == ''){
                        ...
                        <span class="property_menu_item_title"><span class="contact_title"><i class="fas fa-globe"></i></span>
                         ...
                         <span class="property_menu_item_title"><span class="contact_title"><i class="fas fa-globe"></i></span>
                            <?php  
                            $group = esc_html(get_post_meta($post->ID, 'group', true));
                            
                            if($group == 1){
                                echo esc_html__( 'Grupo','wprentals');
                            }else{
                                echo esc_html__( 'Individual','wprentals');
                            }
                            ?>
                        </span>
                    </div>    
                    ...
                    if (is_user_logged_in() && ($user_to_agent==1 || $agent_to_user==1   || $userID == $user_agent_id ) ) {
                        ...
                        print '<div class="owner_contact_details phonedetails">';
                            if ($agent_phone) {
                                print '<div class="property_menu_item"><span class="contact_title"><i class="fas fa-phone"></i></span> <a href="tel:' . $agent_phone . '">' . $agent_phone . '</a></div>';
                            }

                            if ($agent_mobile) {
                                print '<div class="property_menu_item"><span class="contact_title"><i class="fas fa-mobile-alt"></i></span> <a href="tel:' . $agent_mobile . '">' . $agent_mobile . '</a></div>';
                            }
                        print '</div>';
                        
                        print '<div class="owner_contact_details">';
                            if ($agent_email) {
                                print '<div class="property_menu_item agent_email_class"><span class="contact_title"><i class="far fa-envelope"></i></span> <a href="mailto:' . $agent_email . '">' . $agent_email . '</a></div>';
                            }
                            if ($agent_skype) {
                                print '<div class="property_menu_item"><span class="contact_title"><i class="fab fa-skype"></i></span> '. $agent_skype . '</div>';
                            }
                ...
                ?>
                    ...
                    <div class="property_menu_item social_icons_owner">
                        <?php 
                        if($agent_facebook!=''){
                            print ' <a href="'. $agent_facebook.'"><i class="fab fa-facebook-f"></i></a>';
                        }
                        if($agent_twitter!=''){
                            print ' <a href="'.$agent_twitter.'"><i class="fab fa-twitter"></i></a>';
                        }
                        if($agent_linkedin!=''){
                            print ' <a href="'.$agent_linkedin.'"><i class="fab fa-linkedin-in"></i></a>';
                        }
                        if($agent_pinterest!=''){
               ...
               <!--  <div id="contact_me_long_owner" class=" owner_read_more" data-postid="<?php print $agent_id;?>"><?php esc_html_e('Contact Owner','wprentals');?></div> -->
