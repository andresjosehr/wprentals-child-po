...
if ( $comments_data['prop_selection']!='' &&  $comments_data['prop_selection']->have_posts() ) {
    ...
    <?php 
        ...
        second_loop_pagination($comments_data['prop_selection']->max_num_pages,$range =2,$paged,esc_url(get_permalink()));
        //kriesi_pagination_agent(  $comments_data['prop_selection']->max_num_pages, $range =2);    
    ?>     
    </div>
<?php        
} 
