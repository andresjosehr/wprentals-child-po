...
<div  <?php print $schema_data;?>  class="listing_wrapper col-md-12 wide_property property_flex <?php print $listing_type_class;?>" data-org="<?php print $col_org;?>" data-listid="<?php print $post->ID;?>" > 
        ...
        <?php
            ...
            <div class="title-container">
                <div class="price_unit_wrapper">
                    ...
                    if($is_widget==1){
                        echo '<span class="pernight">'.wpestate_show_labels('per night',$rental_type,$booking_type).'</span>';
                    }
                    ?></div> 
                </div>
                ...
                <div class="category_tagline_wrapper">
                    <div class="category_tagline">
                        <img src="<?php echo get_stylesheet_directory_uri() ;?>/img/unit_pin.png"  alt="location">
                    ...
                    <div class="category_tagline"> 
                        <?php if($listing_type==3){
                            ...
                            <img src="<?php echo get_stylesheet_directory_uri() ;?>/img/unit_category.png"  alt="location">
