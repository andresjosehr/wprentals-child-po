...
//error_log("post_thuhmbnail ". print_r($post_thumbnail_id,true));
//error_log("preview ". print_r($preview,true));
...
<div class="listing_main_image" id="listing_main_image_photo" style="background-image: url('<?php print $preview[0];?>')">
    ...
    <div class="listing_main_image_location"  itemprop="location" itemscope itemtype="http://schema.org/Place">
        ...
        <div  class="schema_div_noshow" itemprop="name"><?php echo strip_tags (  $show_city.', '.$property_area); ?></div>
    </div>    
