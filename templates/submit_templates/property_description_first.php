    ...
    <div class="row">   
        ...
        ?>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6"> 
                    <label for="property_description"><?php print $item_description_label;?></label>
                    <textarea  rows="4" id="property_description" name="property_description"  class="advanced_select  form-control" placeholder="<?php esc_html_e('Describe your listing','wprentals');?>"><?php print $property_description; ?></textarea>
                </div>
            </div>
