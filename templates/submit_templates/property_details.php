                ...
                <div class="col-md-6"> 
                    ...
                    ?>
                        ...
                        ?>
                            <div class="col-md-6">
                                <p>
                                    <label for="property_size"> <?php esc_html_e('Size in','wprentals');print ' '.$measure_sys.'<sup>2</sup>';?></label>
                    ...
                    foreach ($details as $label=>$value){
                        ...
                        <div class="extra_detail_option_wrapper">
                            <div class="extra_detail_option col-md-4">
                                <input type="text" class=" extra_option_name form-control" value="'.$label.'">
                            </div>
                            <div class="extra_detail_option col-md-4">
