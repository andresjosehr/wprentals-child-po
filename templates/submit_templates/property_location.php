...
<div class="col-md-12">
        ...
        ?>
            <?php    if(  wprentals_get_option('wp_estate_kind_of_places')!=2){ ?>
                <div class="col-md-12">
                    <div class="col-md-3"></div>
                    <div class="col-md-6">
                        <div id="google_capture"  class="wpb_btn-small wpestate_vc_button  vc_button"><?php esc_html_e('Place Pin with Address','wprentals');?></div>
                    </div>
                </div>
            <?php } ?>
    ...
    <input type="hidden" id="property_city_submit" value="<?php print $property_city?>">
    <input id="property_country" type="hidden" value="<?php print $property_country;?>">
    ...
    <div class="col-md-12" style="display: inline-block;">  
        ...
        <a href="<?php echo  $edit_link_amenities;?>" class="next_submit_page"><?php esc_html_e('Go to Amenities settings.','wprentals');?></a>
