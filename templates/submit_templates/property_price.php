...
<div class="col-md-12">
    ...
    <div class="row">
        ...
        <?php 
            if($service_fee_fixed_fee!=''){
                $tax= $service_fee_fixed_fee.' '.$wp_estate_currency_symbol.' ';
            }else{
                $tax= $service_fee.'% ';
            }
        ...
        <div class="row">       
           <div class="col-md-3 dashboard_chapter_label">
                ...
                <?php
                    ...
                    print $wp_estate_currency_symbol.' '; esc_html_e('(only numbers)','wprentals'); 
                ?>  
                </label>
            </div>
            <div class="col-md-3">    
        ...
        <div class="row">
            <div class="col-md-3 dashboard_chapter_label">
                <label  for="price_per_weekeend"> 
                    ...
                    print $weekedn [$setup_weekend_status];
    ...
    ?>
        <div class="row">
            ...
            <div class="col-md-3"> 
                <label for="cleaning_fee" ><?php esc_html_e('Cleaning Fee in ','wprentals');print $wp_estate_currency_symbol.' '; esc_html_e('(only numbers)','wprentals'); ?></label>
    ...
    ?>
        <div class="row">
            <div class="col-md-3 dashboard_chapter_label">
                <label for="city_fee"><?php esc_html_e('City Fee in ','wprentals');print $wp_estate_currency_symbol.' '; esc_html_e('(only numbers)','wprentals'); ?></label>
            </div>
            <div class="col-md-3">
                <label for="city_fee"><?php esc_html_e('City Fee in ','wprentals');print $wp_estate_currency_symbol.' '; esc_html_e('(only numbers)','wprentals'); ?></label>
    ...
    ?>
        <div class="row">
            <div class="col-md-3 dashboard_chapter_label">
                <label for="security_deposit"> <?php esc_html_e('Security Deposit in ','wprentals');print $wp_estate_currency_symbol.esc_html__(' - will be refunded if no complaints are received from the owner','wprentals'); ?>  </label>
            </div>
            <div class="col-md-3">
    ...
    ?>
        <div class="row">
            ...
            <div class="col-md-3">
                <label for="early_bird_days"> <?php esc_html_e('Minim no of days in advance','wprentals'); ?>  </label>
        ...
        <div class="row">
            ...
            <div class="col-md-3"> 
                <label for="extra_price_per_guest"> 
                    <?php print wpestate_show_labels('extra_price_per_guest',$rental_type,$booking_type);print ' '.$wp_estate_currency_symbol.' ';  ?>
                </label>
    ...
    ?>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <label for="booking_start_hour"><?php esc_html_e('Start Hour','wprentals');?></label>
                    ...
                    if(is_array($extra_pay_options)){
                        foreach($extra_pay_options as $key=>$options){
                            print'<div class="extra_pay_option">';
                                ...
                                print '<input type="text" class="add_option_input extra_option_value form-control" name="'.$options[1].'_value" value="'.$options[1].'">' ;
                                print  wpestate_dropdown_fee_select($options[0]."_type",$options[2],$rental_type,$booking_type);
    ...
    <div class="modal-dialog custom_price_dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-6">
                    <label for="period_extra_price_per_guest"><?php echo wpestate_show_labels('extra_price_per_guest',$rental_type,$booking_type).' '.$wp_estate_currency_symbol;?></label>
