...
if (function_exists('icl_translate') ){
    $prop_stat = apply_filters( 'wpml_translate_single_string', $prop_stat, 'wprentals', 'property_status_'.$prop_stat );
}
$ribbon_class       = str_replace(' ', '-', $prop_stat);    
        
$total_pictures=count ($post_attachments)+1;      
//print '<div class="panel-title panel_pictures">'.esc_html__( 'Property Pictures').'<span class="pictures_explanation">  '. $total_pictures .' '.esc_html__( 'photos','wprentals').'</span></div>';
    ...
    <div id="carousel-listing" class="carousel slide post-carusel carouselvertical" data-ride="carousel" data-interval="false">
        ...
        if( has_post_thumbnail() ){
            ...
            $indicators.= '<li data-target="#carousel-listing" data-slide-to="'.($counter-1).'" class="'. $active.'">
                                ...
                                <img itemprop="image"  src="'.$preview[0].'"  alt="slider" />
                           </li>';
