            ...
            ">
                ...
                <div class="category_wrapper ">
                    <div class="category_icon_wrapper">
                        ...
                        <div class="category_text"><?php print $property_action; ?></div>
                    </div>

                    <div class="category_icon_wrapper">
                        <div class="category_icon"><img src="<?php print $property_category_terms_icon;?>" alt="category" height="25" class="retina_ready"></div>
                        <div class="category_text"><?php print $property_category;?></div>
                    </div>

                    <div class="category_icon_wrapper">
                        <div class="category_icon"><img src="<?php print get_stylesheet_directory_uri().'/img/guest_icon.png';?>" height="25" alt="guests" class="retina_ready"></div>
                        <div class="category_text"><?php print $guests.' '. esc_html__( 'Guests','wprentals');?></div>
                    </div>

                    <div class="category_icon_wrapper">
                        <div class="category_icon"><img src="<?php print get_stylesheet_directory_uri().'/img/beds_icon.png';?>" height="25" alt="bedrooms" class="retina_ready"></div>
                        <div class="category_text"><?php print $bedrooms.' '.esc_html__( 'Bedrooms','wprentals');?></div>
                    </div>
                </div>
                ...
                <?php
                    ...
                    $property_description_text =  wprentals_get_option('wp_estate_property_description_text');
                    if (function_exists('icl_translate') ){
                        $property_description_text     =   icl_translate('wprentals','wp_estate_property_description_text', esc_html( wprentals_get_option('wp_estate_property_description_text') ) );
                    }
        ...
        <div id="booking_form_request_mess"></div>
            <h3 ><?php esc_html_e('Book Now','wprentals');?></h3>
                ...
                <div class="has_calendar calendar_icon">
                    <input type="text" id="start_date" placeholder="<?php  echo wpestate_show_labels('check_in',$rental_type); ?>"  class="form-control calendar_icon" size="40" name="start_date" value="">
                </div>

                <div class=" has_calendar calendar_icon">
                    <input type="text" id="end_date" disabled placeholder="<?php  echo wpestate_show_labels('check_out',$rental_type); ?>" class="form-control calendar_icon" size="40" name="end_date" value="">
                </div>
                ...
                <div class=" has_calendar guest_icon ">
                    ...
                    <div class="dropdown form-control">
                        ...
                        <ul  class="dropdown-menu filter_menu" role="menu" aria-labelledby="booking_guest_no_wrapper" id="booking_guest_no_wrap
                        '.$guest_list.'
                ...
                <div class="submit_booking_front_wrapper">
                    ...
                    if($instant_booking ==1){ ?>
                        <div id="submit_booking_front_instant_wrap"><input type="submit" id="submit_booking_front_instant" data-maxguest="<?php print $max_guest; ?>" property_header_1 data-overload="<?php print $overload_guest;?>" data-guestfromone="<?php print $price_per_guest_from_one; ?>"  class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button" value=" <?php esc_html_e('Instant Booking','wprentals');?>" /></div>
                    <?php }else{?>   
                        <input type="submit" id="submit_booking_front" data-maxguest="<?php print $max_guest; ?>" data-overload="<?php print $overload_guest;?>" property_header_1 data-guestfromone="<?php print $price_per_guest_from_one; ?>"  class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button" value="<?php esc_html_e('Book Now','wprentals');?>" />
                    <?php }?>
