         ...
         <div class="prop-info">
            ...
            ?>
                ...
                <div class="info-container">
                    <a  data-original-title="<?php esc_html_e('Edit property','wprentals');?>"   class="dashboad-tooltip" href="<?php  print $edit_link;?>"><i class="fas fa-pencil-alt editprop"></i></a>
                    <a  data-original-title="<?php esc_html_e('Delete property','wprentals');?>" class="dashboad-tooltip" onclick="return confirm(' <?php echo esc_html__( 'Are you sure you wish to delete ','wprentals').get_the_title(); ?>?')" href="<?php print esc_url ( add_query_arg( 'delete_id', $post_id,esc_url($_SERVER['REQUEST_URI']) ) );?>"><i class="fas fa-times deleteprop"></i></a>  
                    <?php
                    if( $post_status == 'expired' ){ 
                    ...
                    if( $post_status == 'publish' ){ 
                        print ' <span  data-original-title="'.esc_html__( 'Disable Listing','wprentals').'" class="dashboad-tooltip disable_listing" data-postid="'.$post_id.'" ><i class="fas fa-pause"></i></span>';
                    }else if($post_status=='disabled') {
                        print ' <span  data-original-title="'.esc_html__( 'Enable Listing','wprentals').'" class="dashboad-tooltip disable_listing" data-postid="'.$post_id.'" ><i class="fas fa-play"></i></span>';
                    }
