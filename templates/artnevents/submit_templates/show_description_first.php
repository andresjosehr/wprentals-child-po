...
<div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6"> 
                <p>
                   ...
                   <textarea type="text" id="show_description" class="form-control" value="" size="20" name="show_description"><?php print $show_description; ?>
                   </textarea>
                </p>
            </div>    
    ...
    <div class="col-md-12" style="display: inline-block;">   
        <?php if ( is_user_logged_in() ) {    ?>
            <input type="submit"  class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button"  id="form_submit_desc" value="<?php esc_html_e('Continue', 'wprentals') ?>" />
        <?php }else{ ?>
            <input type="submit"  class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button externalsubmit"    id="form_submit_desc" value="<?php esc_html_e('Continue', 'wprentals') ?>" />
