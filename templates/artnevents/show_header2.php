                ...
                <div class="category_wrapper ">
                    <div class="category_details_wrapper">
                        ...
                        if(wprentals_get_option( 'wp_estate_use_custom_icon_area') =='yes' ){ 
                            error_log("wprentals_icon_bar_design");
                            //wprentals_icon_bar_design();
                        }else{
                            error_log("wprentals_icon_bar_classic");
        ...
        <div id="booking_form_request_mess"></div>
            <h3 ><?php esc_html_e('Book Now','wprentals');?></h3>
                ...
                <div class="has_calendar calendar_icon">
                    ...
                    //echo wpestate_show_labels('check_in',$rental_type);  
                    esc_html_e('Day','wprentals'); ?>"  class="form-control calendar_icon" size="40" name="start_date" 
                ...
                ?>
                   ...
                   <!-- <input type="hidden" name="number_members"  value="1"> -->
                <?php 
                }
                ?>
                ...
                <div class="submit_booking_front_wrapper">
                    ...
                    $show_number_members            =   floatval   ( get_post_meta($post_id, 'show_number_members', true) );
