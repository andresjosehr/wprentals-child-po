<div class="property_menu_wrapper_hidden <?php echo 'prop_menu_search_stick_'.wprentals_get_option('wp_estate_sticky_search');?>">
    <div class="property_menu_wrapper_insider">
        ...
        <a class="property_menu_item" href="#listing_images"><?php esc_html_e('Images','wprentals')?></a>
         <a class="property_menu_item" href="#listing_video"><?php esc_html_e('Video','wprentals')?></a>
