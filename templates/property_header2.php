        ...
        <div id="booking_form_request_mess"></div>
            <h3 ><?php esc_html_e('Book Now','wprentals');?></h3>
                ...
                <div class="submit_booking_front_wrapper">
                    ...
                    <?php }else{?>   
                        <input type="submit" id="submit_booking_front" data-maxguest="<?php print $max_guest; ?>" data-overload="<?php print $overload_guest;?>" property_header_2 data-guestfromone="<?php print $price_per_guest_from_one; ?>"  class="wpb_btn-info wpb_btn-small wpestate_vc_button  vc_button" value="<?php esc_html_e('Book Now','wprentals');?>" />
                    <?php }?>
