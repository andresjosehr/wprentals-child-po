        ...
        <?php } else {
                ...
                foreach($adv_search_what as $key=>$search_field){
                    ...
                    print '<div class="col-md-12 '.str_replace(" ","_", stripslashes($search_field) ).' ">';
                        print wpestate_show_search_field_new($_REQUEST,'mobile',$search_field,$action_select_list,$categ_select_list,$select_city_list,$select_area_list,$key,$show_city_select_list,$show_artistic_discipline_list);
