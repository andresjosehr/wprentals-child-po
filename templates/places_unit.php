...
<div class="places_slider_wrapper_type_1" data-link="<?php echo esc_url($term_link);?>" style="background-image: url(<?php print $category_featured_image_url; ?>)"> 
