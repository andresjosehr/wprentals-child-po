...
<div class="adv-search-2 <?php print $google_map_lower_class.' '.$close_class.' '.$extended_class;?>" id="adv-search-1" data-postid="<?php print $post_id; ?>"> 
    ...
    <form  method="get"  id="main_search" action="<?php print $adv_submit; ?>" >
        ...
        <div class="col-md-12 map_icon">       
            ...
            ?>
            <input type="hidden" id="advanced_city"      class="form-control" name="advanced_city" data-value=""   value="<?php echo  $advanced_city; ?>" >              
            <input type="hidden" id="advanced_area"      class="form-control" name="advanced_area"   data-value="" value="<?php echo  $advanced_area; ?>" >              
            <input type="hidden" id="advanced_country"   class="form-control" name="advanced_country"   data-value="" value="<?php echo  $advanced_country; ?>" >              
        ...
        <div id="results">
            ...
            <span id="showinpage"> <?php esc_html_e('Show the results now ?','wprentals');?> </span>
        </div>
