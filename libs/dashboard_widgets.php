...
function wpestate_add_welcome_widget(){
    ...
    if ($logo != '') {
        print '<img class="dashboard_widget_logo admin_widget_logo" src="' . $logo . '" class="img-responsive retina_ready"  alt="logo"/>';
    } else {
...
function wpestate_add_new_property_widget(){
    ...
    print '<a class="wpestate_admin_button reverse_but" style="margin-top:10px;" href="'.$add_link.'">'.__('Add New Property','wprentals').'</a>';
