...
function wpestate_scripts() {   
    ...
    if(is_singular('estate_agent')){
        $global_header_type         =   wprentals_get_option('wp_estate_user_header_type','');
    }
    ...
    if($what_place==2){
        wp_enqueue_script('wpestate_mapbox-sdk',trailingslashit( get_template_directory_uri() ).'js/openstreet/places.js@1.13.0',array('jquery'), '1.0', true);   
        wp_enqueue_script('wpestate_mapbox-algoliasearch',trailingslashit( get_template_directory_uri() ).'js/openstreet/algoliasearch.min.js',array('jquery'), '1.0', true);  
    }
    ...
    if($date_lang_status!='xx'){
        ...
        wp_enqueue_script('wprentals_per_hour_locale', trailingslashit( get_template_directory_uri() ).'js/locale/'.strtolower($date_lang_status).'.js',array('jquery'), '1.0', true);
    }
    ...
    if($what_map==1){
        ...
        wp_enqueue_script('wpestate_leaflet',trailingslashit( get_template_directory_uri() ).'js/openstreet/leaflet.js',array('jquery'), '1.0', true); 
        wp_enqueue_style('wpestate_leaflet_css', trailingslashit( get_template_directory_uri() ).'js/openstreet/leaflet.css', array(), '1.0', 'all'); 

        wp_enqueue_script('wpestate_leaflet_cluster',trailingslashit( get_template_directory_uri() ).'js/openstreet/leaflet.markercluster.js',array('jquery'), '1.0', true); 
        wp_enqueue_style('wpestate_leaflet_css_markerCluster', trailingslashit( get_template_directory_uri() ).'js/openstreet/MarkerCluster.css', array(), '1.0', 'all'); 
        wp_enqueue_style('wpestate_leaflet_css_markerCluster_default', trailingslashit( get_template_directory_uri() ).'js/openstreet/MarkerCluster.Default.css', array(), '1.0', 'all'); 
    }
   ...
   // if ( is_page_template('property_list.php') || is_page_template('property_list_half.php') || is_page_template('advanced_search_results.php') ){
    if ( is_page_template('property_list_half.php') || ( is_page_template('advanced_search_results.php') && $wp_estate_property_list_type_adv==2) ){
        $is_property_list=1;  
    }
    
    
    
if ( is_page_template('user_dashboard_edit_listing.php') || is_page_template('property_list_half.php')  ){
        $load_extra =   1; 
    }
   ...
   //     wp_enqueue_script('wpestate_markerclusterer', trailingslashit( get_template_directory_uri() ).'js/google_js/markerclusterer.js',array('jquery'), '1.0', true);  
    ...
    wp_localize_script('wpestate_control', 'control_vars', 
            array(  'searchtext'            =>   esc_html__( 'SEARCH','wprentals'),
                    ...
                    'datepick_lang'         =>  esc_html ( wprentals_get_option('wp_estate_date_lang','') ),
