...
function rentals_is_tax_case($term){
    ...
    if($term=='property_category' || $term=='property_action_category' || $term=='property_city' || $term=='property_area' || $term=='show_tax_artistic_discipline' ){
        return true;
    }
    return false;
    ...
    function wpestate_get_action_select_list_4all($args,$taxonomy){
        ...
        if($categ_select_list===false){
            ...
            if($taxonomy=='property_category'){
                ...
                $categ_select_list  =   ' <li role="presentation" data-value="all">'.  esc_html__('All Disciupl','wprentals').'</li>';
            }
